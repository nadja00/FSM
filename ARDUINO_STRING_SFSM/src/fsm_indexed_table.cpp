...
static const uint8_t transition_table[NUM_STATES][NUM_EVENTS] = {
    /*             INV_CHAR M_FOUND A_FOUND T_FOUND */
    /* START   */ { START, M_STATE, START,   START   },
    /* M_STATE */ { START, M_STATE, A_STATE, START   },
    /* A_STATE */ { START, START,   START,   T_STATE },
    /* T_STATE */ { START, START,   START,   START   }
};
...
static void run_benchmark(void) {
    ...
    uint32_t sum_c = 0;  // M_FOUND, A_FOUND, T_FOUND, INV_CHAR
    uint8_t ev_cycle[4] = { 1, 2, 3, 0 };
