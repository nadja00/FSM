...
static const Transition transition_table[] = {
    { START,   INV_CHAR, START   },
    { START,   M_FOUND,  M_STATE },
    { M_STATE, INV_CHAR, START   },
    { M_STATE, M_FOUND,  M_STATE },
    { M_STATE, A_FOUND,  A_STATE },
    { A_STATE, INV_CHAR, START   },
    { A_STATE, T_FOUND,  T_STATE },
    { T_STATE, INV_CHAR, START   }
};
