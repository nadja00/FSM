 ...
 *
 * Access Control FSM - Array of Structs Pattern - ESP32
 * Transition lookup is a LINEAR SEARCH over an array of {state, event, next_state} structs.
 *
...
void setup() {
    ...
    delay(200);
    Serial.println();
    Serial.println(F("Access FSM - Array of Structs pattern ready (ESP32)."));
