...
static StateHandler const state_handlers[NUM_STATES] = {
    state_s0_handle, state_s1_handle, state_s2_handle, state_s3_handle,
    state_s4_handle, state_s5_handle, state_s6_handle, state_s7_handle,
    state_s8_handle, state_s9_handle, state_s10_handle, state_s11_handle,
    state_s12_handle, state_s13_handle, state_s14_handle, state_s15_handle
};
...
void setup()
{
    ...
    delay(200);
    Serial.println();
    Serial.println(F("MQTT FSM - State Object pattern ready (ESP32)."));
