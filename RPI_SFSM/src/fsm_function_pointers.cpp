 ...
 * Raspberry Pi / Linux port. 2D niz cuva POKAZIVACE NA FUNKCIJE, ne next_state
 * vrednosti direktno (za to vidi fsm_indexed_table.cpp). Vidi
 * fsm_nested_switch_return.cpp za napomene o Linux adaptaciji.
 *
...
int main(void) {
    ...
    printf("\nAccess FSM - Function Pointers pattern ready (Raspberry Pi / Linux).\n");
