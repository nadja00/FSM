 ...
 *
 * Access Control FSM - Indexed Table Pattern (O(1) lookup) - Raspberry Pi / Linux port.
 * Transition lookup je DIREKTNO 2D indeksiranje [state][event] -> next_state.
...
int main(void) {
    ...
    printf("\nAccess FSM - Indexed Table pattern ready (Raspberry Pi / Linux).\n");
