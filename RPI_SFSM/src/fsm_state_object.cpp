 ...
 * Raspberry Pi / Linux port. Svako stanje "poseduje" svoj handler; dispatch
 * ide preko niza pokazivaca na funkcije indeksiranog SAMO po stanju (ne i po
 * dogadjaju) - hendler sam odlucuje sta da radi sa dogadjajem.
 * Vidi fsm_nested_switch_return.cpp za napomene o Linux adaptaciji.
 *
...
int main(void) {
    ...
    printf("\nAccess FSM - State Object pattern ready (Raspberry Pi / Linux).\n");
