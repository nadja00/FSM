 ...
 * Raspberry Pi / Linux port. Svaki unos u nizu struct-ova ovde ne cuva
 * next_state direktno vec POKAZIVAC NA eventHandler FUNKCIJU (tacno kao
 * "stateMachineEventHandler" polje u radu). Vidi fsm_nested_switch_return.cpp
 * za napomene o Linux adaptaciji.
 *
...
int main(void) {
    ...
    printf("\nAccess FSM - Array of Structs (eventHandler) pattern ready (Raspberry Pi / Linux).\n");
